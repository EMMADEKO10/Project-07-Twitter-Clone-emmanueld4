        ...
        <div className="" >
            ...
            <div className="action-content">
                ...
                <svg onClick={eventOfClick} className={`hoverIcon ${isHovered ? "hovered" : ""}`} width="14" height="50" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d={url} fill={isHovered ? (url === urlretweet ? "red" : " rgba(29, 155, 240, 1)") : colorFill} onMouseEnter={handleMouseEnter}
                        onMouseLeave={handleMouseLeave} />
                </svg>     

                <span
                    className={`hoverText ${isHovered ? (url === urlretweet ? "hoverLike" : "hoverOtherIcon") : ""}`}
